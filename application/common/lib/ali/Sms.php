...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIskVofSHAHVFJ"; // AccessKeyId

        $accessKeySecret = "QMaaNKTdPPFczDhKllaymrrgsZdg5z"; // AccessKeySecret
    ...
    public static function sendSms($mobile, $code) {
        ...
        $request->setSignName("比博");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_138530313");
